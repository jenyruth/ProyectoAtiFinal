<footer class="main-footer">
            ...
            <strong>Copyright &copy; 2019 <a href="https://codemyn.blogspot.com/">By Team JARNY</a>.</strong> All rights
            reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
<!-- jQuery 3 -->
<script src="<?php echo base_url();?>public/template/jquery/jquery.min.js"></script>
<!-- Bootstrap 3.3.7 -->
...
<script>
  $(document).ready(function(){
    ...
    $(".btn-Postulante").on("click",function(){
