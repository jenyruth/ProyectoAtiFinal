...
<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="<?php echo base_url();?>public/template/dist/css/AdminLTE.min.css">
    <!-- AdminLTE Skins. Choose a skin from the css/skins
    folder instead of downloading all of them to reduce the load. -->
    <link rel="stylesheet" href="<?php echo base_url();?>public/template/dist/css/skins/_all-skins.min.css">
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
        <header class="main-header">
            <!-- Logo -->
            <a href="<?php echo base_url();?>../CPU-UNAMBA/" class="logo">
                <!-- mini logo for sidebar mini 50x50 pixels -->
                <span class="logo-mini"><b>CP</b>U</span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"><b>CPU-UNAMBA</b></span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php echo base_url()?>public/template/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
